...
export const DrawingCanvas = ({
  ...
  const handleMouseUp = () => {
    ...
    if (selectedLabel) {
      ...
      const categoryAnnotations = annotations.filter(a => a.category_id === selectedLabel);
      ...
      {annotations.map((annotation, idx) => (
        <div
          ...
          style={{
            ...
            backgroundColor: annotation.category_id ? getLabelColor(annotation.category_id) : 'rgba(255, 255, 255, 0.1)',
            borderColor: annotation.category_id ? getLabelBorderColor(annotation.category_id) : 'gray'
          }}
        >
          {annotation.category_id && (
            <span 
              ...
              style={{
                backgroundColor: annotation.category_id ? getLabelBorderColor(annotation.category_id) : 'gray',
              }}
            >
      ...
      {currentRect && (
        <div
          ...
          style={{
            ...
            borderColor: selectedLabel ? getLabelBorderColor(selectedLabel) : 'rgba(0, 0, 255, 0.7)'
          }}
        />
      )}
    </div>
